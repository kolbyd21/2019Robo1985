...
public class TankDrive extends Subsystem {
    ...
    public TankDrive() {
        ...
        speedControllerGroupRight = new SpeedControllerGroup(rightFront, rightRear  );
        ...
        leftRear = new VictorSP(4);
        addChild("LeftRear",leftRear);
        leftRear.setInverted(false);
        
        speedControllerGroupLeft = new SpeedControllerGroup(leftFront, leftRear  );
